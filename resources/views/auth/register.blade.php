            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              @csrf
                <div class="form-group">
                  <input type="text"name="name" :value="old('name')" class="form-control form-control-lg" id="name" placeholder="Name">
                </div>
                ...
                <div class="form-group">
                  <input type="number" name="phone_number" :value="old('phone_number')" class="form-control form-control-lg" id="phone_number" placeholder="Phone Number">
                </div>
