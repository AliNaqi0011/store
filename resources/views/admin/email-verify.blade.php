        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- <div class="row">
                        <div class="col-md-6">
                            <h5 class="card-title text-center">Email:{{$userEmail}}</h5>
                        </div>
                        <div class="col-md-6">
                            <h5 class="card-title">Phone Number: {{$userPhone}}</h5>
                        </div>
                    </div> -->
                    <form class="pt-3" method="POST" action="{{ route('verify.email.phone.otp') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <label for=""><b>Email OTP</b></label>
                                <div class="form-group">
                                    <input type="number" name="email_otp" :value="old('email_otp')" class="form-control form-control-md" id="email_otp" placeholder="Enter Email OTP">
                                </div>
