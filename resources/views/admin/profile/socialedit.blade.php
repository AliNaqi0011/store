                    ...
                    <form class="pt-3" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="facebook" value="{{ $userSocial->facebook ?? '' }}"
                                        class="form-control form-control-md" id="facebook"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group mt-md-0 mt-3">
                                    <input type="text" name="instagram" value="{{ $userSocial->instagram ?? '' }}"
                                        class="form-control form-control-md" id="instagram" placeholder="Enter Phone OTP">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group mt-md-0 mt-3">
                                    <input type="text" name="twitter" value="{{ $userSocial->twitter ?? '' }}"
                                        class="form-control form-control-md" id="twitter" placeholder="Enter Phone OTP">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="github" value="{{ $userSocial->github ?? '' }}"
                                        class="form-control form-control-md" id="github" placeholder="Enter your github">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group mt-md-0 mt-3">
                                    <input type="text" name="website" value="{{ $userSocial->website ?? '' }}"
                                        class="form-control form-control-md" id="website" placeholder="Enter Phone OTP">
                                </div>
