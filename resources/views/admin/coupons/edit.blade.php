...
@section('page-description', 'Update coupon information')
...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="maximum_discount" value="{{ old('maximum_discount', $coupon->maximum_discount) }}" step="0.01" min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-6">Status & Usage</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="text-sm text-gray-600">Usage Statistics</div>
                    <div class="text-2xl font-bold text-gray-900">{{ $coupon->used_count }}</div>
