...
@section('page-description', 'Update brand information')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              ...
                              placeholder="Brand description (optional)">{{ old('description', $brand->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <img src="{{ asset('storage/' . $brand->logo) }}" alt="{{ $brand->name }}" class="w-32 h-32 object-cover rounded-lg border border-gray-200">
                    </div>
                    @endif
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors" id="logoUploadArea">
                        <div class="space-y-2">
                            ...
                            <p class="text-gray-600">Click to upload new logo or drag and drop</p>
